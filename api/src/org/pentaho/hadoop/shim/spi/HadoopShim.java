 ...
 * Users should obtain a shim implementation through a
 * {@link HadoopConfiugration} via {@link HadoopConfigurationProvider}.
 * 
...
public interface HadoopShim extends PentahoHadoopShim {
  ...
  /**
   * This is executed once the shim has been loaded. It provides a way for the
   * shim implementation to register a VFS file provider.
   * 
   ...
   */
  void onLoad(HadoopConfiguration config,
    HadoopConfigurationFileSystemManager fsm) throws Exception;
   ...
   * @return Tuple of {hostname, port} of the namenode if the connection
   ...
   * @return Tuple of {hostname, port} of the jobtracker if the connection
   *         information could be determined.
   */
   ...
   * 
   * @return The Hadoop version that is abstracted behind this shim
   *         implementation.
   */
  String getHadoopVersion();

  /**
   * Creates a Configuration with default properties loaded from the Hadoop
   * configuration.
   * 
   ...
   * @return A File system abstraction configured with the properties found in
   *         {@code conf}
  ...
  /**
   * Setup the config object based on the supplied information with respect to
   ...
   * @throws Exception Error configuring with the provided connection
   *           information
   */
  void configureConnectionInformation(String namenodeHost, String namenodePort,
    String jobtrackerHost, String jobtrackerPort, Configuration conf,
   ...
   * @return Java type to convert {@code kettleType} to when sending data back
   *         to Hadoop.
   * @deprecated To be replaced with a cleaner API for executing Pentaho
   *             MapReduce. Use with care.
   */
  @Deprecated
  Class<?> getHadoopWritableCompatibleClass(ValueMetaInterface kettleType);

  /**
   * Get the named writable type
   * 
   * @param className the name of the writable class
   * @return the class of the writable
   * @throws ClassNotFoundException if the class can't be found
   */
  public Class<?> getNamedHadoopWritableClass(String className)
