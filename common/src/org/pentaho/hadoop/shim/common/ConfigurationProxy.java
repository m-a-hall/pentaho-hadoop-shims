 ...
 * <p>
 * This has been un-deprecated in future version of Hadoop and thus the deprecation warning can be safely ignored.
 * </p>
 */
...
public class ConfigurationProxy extends org.apache.hadoop.mapred.JobConf implements
  ...
  /*
   * Wrap the call to {@link super#setMapperClass(Class)} to avoid generic type mismatches. We do not expose {@link
   * org.apache.hadoop.mapred.*} classes through the API or provide proxies for them. This pattern is used for many of
   * the class setter methods in this implementation.
   */
